import { localizedCopy, t, useLocale } from "@/lib/i18n";
...
import {
  LearnDetailHeader,
  learnDetailContent,
} from "@/components/learn/LearnDetailHeader";
  ...
  steps: [
    {
      ...
      detail:
        "How easily you burn, how many moles you have, and how your skin usually reacts to sun.",
    },
    {
      title: "Your sun history",
      detail:
        "Time spent outdoors, past sunburns, and the protection you normally use.",
    },
    {
      title: "Family and medical background",
      detail:
        "Whether skin cancer runs in your family, and anything relevant in your own history.",
    },
    {
      title: "Your personalised summary",
      detail:
        "A plain-language read on how often to check your skin, and when it is worth seeing a dermatologist.",
    },
  ],
});
    ...
    <Screen padded={false}>
      ...
      >
        <View style={styles.body}>
          <Card
            padded={false}
            style={[styles.hero, { borderColor: theme.hairline }]}
          >
            <View
              style={[styles.heroArt, { backgroundColor: theme.brandTint }]}
              accessible={false}
            >
            ...
            <View style={styles.heroText}>
              <View style={styles.eyebrowRow}>
                <ThemedText
                  type="caption"
                  style={[styles.eyebrow, { color: theme.brandPressed }]}
                >
                  {t("SELF-CHECK")}
                </ThemedText>
                <View
                  style={[styles.badge, { backgroundColor: theme.elementBg }]}
                >
                  <ThemedText
                    type="caption"
              ...
              <ThemedText type="callout" themeColor="textSecondary">
                {t(
                  "A guided set of questions that turns what you know about your own skin into a clear sense of how closely to watch it.",
                )}
              </ThemedText>
            </View>
          </Card>
          ...
          <View style={[styles.note, { backgroundColor: theme.brandTint }]}>
            ...
            >
              {t(
                "The questionnaire will estimate how much attention your skin needs. It will not diagnose anything, and it does not replace advice from a dermatologist.",
              )}
            </ThemedText>
          </View>
        </View>
